...
<body style="background: #1a2026;">
    ...
    <main id="main">
        <!-- ======= Hero Contacts ======= -->
        <?php
        include "modules/events/hero_events.php"
        ?>
        <!-- ======= End Hero Contacts ======= -->

        <!-- ======= Breadcrumbs ======= -->
        <?php
        include "modules/events/breadcrumbs_events.php"
        ?>
        <!-- ======= End Breadcrumbs ======= -->

        <!-- ======= Breadcrumbs ======= -->
        <?php
        include "modules/events/about_events.php"
        ?>
        <!-- ======= End Breadcrumbs ======= -->

        <!-- ======= Event Formats ======= -->
        <?php
        include "modules/events/event_formats.php"
        ?>
        <!-- ======= End Event Formats ======= -->
