...
<body style="background: #1a2026;">
    ...
    <!-- Feedback Form -->
    <?php
    include "modules/booking/feedback_form.php"
    ?>
    ...
    <main id="main">
        ...
        <!-- ======= Hero Contacts ======= -->
        <?php
        include "modules/booking/hero_booking.php"
        ?>
        ...
        <!-- ======= Breadcrumbs ======= -->
        <?php
        include "modules/booking/breadcrumbs_booking.php"
        ?>
        <!-- ======= End Breadcrumbs ======= -->

        <!-- ======= About Basketball ======= -->
        <?php
        include "modules/booking/about_booking.php"
        ?>
        <!-- ======= End About ======= -->

        <!-- ======= Cards ======= -->
        <?php
        include "modules/booking/booking_info.php"
        ?>
        <!-- ======= End Cards ======= -->

        <!-- ======= Basketball Photos ======= -->
        <?php
        include "modules/booking/booking_photos.php"
        ?>
        <!-- ======= End  Photos ======= -->
