...
<body style="background: #1a2026;">
    ...
    <main id="main">
        <!-- ======= Hero Athletics ======= -->
        <?php
        include "modules/athletics/hero_athletics.php"
        ?>
        <!-- ======= End Hero Athletics ======= -->

        <!-- ======= Breadcrumbs ======= -->
        <?php
        include "modules/athletics/breadcrumbs_atthletics.php"
        ?>
        <!-- ======= End Breadcrumbs ======= -->

        <!-- ======= About Athletics ======= -->
        <?php
        include "modules/athletics/about_athletics.php"
        ?>
        <!-- ======= End ======= -->

        <!-- ======= Athletics Cards ======= -->
        <?php
        include "modules/athletics/athletics_cards.php"
        ?>
        <!-- ======= End Cards ======= -->

        <!-- ======= Athletics Photos ======= -->
        <?php
        include "modules/athletics/athletics_photos.php"
        ?>
        <!-- ======= End Athletics Photos ======= -->
