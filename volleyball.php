...
<body style="background: #1a2026;">
    ...
    <main id="main">
        <!-- ======= Hero Volleyball ======= -->
        <?php
        include "modules/volleyball/hero_volleyball.php"
        ?>
        <!-- ======= End Hero Volleyball ======= -->

        <!-- ======= Breadcrumbs ======= -->
        <?php
        include "modules/volleyball/breadcrumbs_volleyball.php"
        ?>
        <!-- ======= End Breadcrumbs ======= -->

        <!-- ======= About Volleyball ======= -->
        <?php
        include "modules/volleyball/about_volleyball.php"
        ?>
        <!-- ======= End ======= -->

        <!-- ======= Volleyball Cards ======= -->
        <?php
        include "modules/volleyball/volleyball_cards.php"
        ?>
        <!-- ======= End Cards ======= -->

        <!-- ======= Volleyball Photos ======= -->
        <?php
        include "modules/volleyball/volleyball_photos.php"
        ?>
