...
<body style="background: #1a2026;">
    ...
    <main id="main">
        <!-- ======= Hero Contacts ======= -->
        <?php
        include "modules/basketball/hero_basketball.php"
        ?>
        <!-- ======= End Hero Contacts ======= -->

        <!-- ======= Breadcrumbs ======= -->
        <?php
        include "modules/basketball/breadcrumbs_basketball.php"
        ?>
        <!-- ======= End Breadcrumbs ======= -->

        <!-- ======= About Basketball ======= -->
        <?php
        include "modules/basketball/about_basketball.php"
        ?>
        <!-- ======= End About ======= -->

        <!-- ======= Basketball Cards ======= -->
        <?php
        include "modules/basketball/basketball_cards.php"
        ?>
        <!-- ======= End Cards ======= -->

        <!-- ======= Basketball Photos ======= -->
        <?php
        include "modules/basketball/basketball_photos.php"
        ?>
